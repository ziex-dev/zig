...
pub fn dup(old: fd_t) usize {
    return syscall1(.dup, usizeFromFd(old));
}

pub fn dup2(old: fd_t, new: fd_t) usize {
    if (@hasField(SYS, "dup2")) {
        return syscall2(.dup2, usizeFromFd(old), usizeFromFd(new));
    } else {
        if (old == new) {
            ...
            return syscall3(.dup3, usizeFromFd(old), usizeFromFd(new), 0);
        }
    }
}

pub fn dup3(old: fd_t, new: fd_t, flags: u32) usize {
    return syscall3(.dup3, usizeFromFd(old), usizeFromFd(new), flags);
}
...
pub fn fchdir(fd: fd_t) usize {
    return syscall1(.fchdir, usizeFromFd(fd));
}
...
pub fn execveat(dirfd: fd_t, path: [*:0]const u8, argv: [*:null]const ?[*:0]const u8, envp: [*:null]const ?[*:0]const u8, flags: EXECVEAT) usize {
    return syscall5(.execveat, usizeFromFd(dirfd), @intFromPtr(path), @intFromPtr(argv), @intFromPtr(envp), @as(u32, @bitCast(flags)));
}
...
pub fn fallocate(fd: fd_t, mode: i32, offset: i64, length: i64) usize {
    if (usize_bits < 64) {
...
pub fn inotify_add_watch(fd: fd_t, pathname: [*:0]const u8, mask: u32) usize {
    return syscall3(.inotify_add_watch, usizeFromFd(fd), @intFromPtr(pathname), mask);
}

pub fn inotify_rm_watch(fd: fd_t, wd: wd_t) usize {
    return syscall2(.inotify_rm_watch, usizeFromFd(fd), usizeFromI32(wd));
}
...
pub fn readlink(noalias path: [*:0]const u8, noalias buf_ptr: [*]u8, buf_len: usize) usize {
    if (@hasField(SYS, "readlink")) {
        ...
        return syscall4(.readlinkat, usizeFromFd(AT.FDCWD), @intFromPtr(path), @intFromPtr(buf_ptr), buf_len);
    }
}

pub fn readlinkat(dirfd: fd_t, noalias path: [*:0]const u8, noalias buf_ptr: [*]u8, buf_len: usize) usize {
    return syscall4(.readlinkat, usizeFromFd(dirfd), @intFromPtr(path), @intFromPtr(buf_ptr), buf_len);
}
...
pub fn mkdir(path: [*:0]const u8, mode: mode_t) usize {
    if (@hasField(SYS, "mkdir")) {
        ...
        return syscall3(.mkdirat, usizeFromFd(AT.FDCWD), @intFromPtr(path), mode);
    }
}

pub fn mkdirat(dirfd: fd_t, path: [*:0]const u8, mode: mode_t) usize {
    return syscall3(.mkdirat, usizeFromFd(dirfd), @intFromPtr(path), mode);
}
...
pub fn mknodat(dirfd: fd_t, path: [*:0]const u8, mode: u32, dev: u32) usize {
    return syscall4(.mknodat, usizeFromFd(dirfd), @intFromPtr(path), mode, dev);
}
...
pub fn move_mount(from_dirfd: fd_t, from_path: [*:0]const u8, to_dirfd: fd_t, to_path: [*:0]const u8, flags: MOVE_MOUNT) usize {
    return syscall5(.move_mount, usizeFromFd(from_dirfd), @intFromPtr(from_path), usizeFromFd(to_dirfd), @intFromPtr(to_path), @as(u32, @bitCast(flags)));
}
...
pub fn mount_setattr(dirfd: fd_t, path: [*:0]const u8, flags: MOUNT_ATTR) usize {
    return syscall3(.mount_setattr, usizeFromFd(dirfd), @intFromPtr(path), @as(u32, @bitCast(flags)));
}
...
pub fn fsconfig(fd: fd_t, cmd: FSCONFIG_CMD, key: ?[*:0]const u8, value: ?[*:0]const u8, aux: u32) usize {
    return syscall5(.fsconfig, usizeFromFd(fd), @intFromEnum(cmd), @intFromPtr(key), @intFromPtr(value), aux);
}
...
pub fn fsmount(fsfd: fd_t, flags: FSMOUNT, attr_flags: MOUNT_ATTR) usize {
    return syscall3(.fsmount, usizeFromFd(fsfd), @as(u32, @bitCast(flags)), @as(u32, @bitCast(attr_flags)));
}
...
pub fn fspick(dirfd: fd_t, path: [*:0]const u8, flags: FSPICK) usize {
    return syscall3(.fspick, usizeFromFd(dirfd), @intFromPtr(path), @as(u32, @bitCast(flags)));
}
...
pub fn mmap(address: ?[*]u8, length: usize, prot: PROT, flags: MAP, fd: fd_t, offset: i64) usize {
...
pub fn read(fd: fd_t, buf: [*]u8, count: usize) usize {
    return syscall3(.read, usizeFromFd(fd), @intFromPtr(buf), count);
}

pub fn preadv(fd: fd_t, iov: [*]const iovec, count: usize, offset: i64) usize {
...
pub fn preadv2(fd: fd_t, iov: [*]const iovec, count: usize, offset: i64, flags: kernel_rwf) usize {
    const offset_u: u64 = @bitCast(offset);
    return syscall6(
        .preadv2,
        usizeFromFd(fd),
...
pub fn readv(fd: fd_t, iov: [*]const iovec, count: usize) usize {
    return syscall3(.readv, usizeFromFd(fd), @intFromPtr(iov), count);
}

pub fn writev(fd: fd_t, iov: [*]const iovec_const, count: usize) usize {
    return syscall3(.writev, usizeFromFd(fd), @intFromPtr(iov), count);
}

pub fn pwritev(fd: fd_t, iov: [*]const iovec_const, count: usize, offset: i64) usize {
    const offset_u: u64 = @bitCast(offset);
    return syscall5(
        .pwritev,
        usizeFromFd(fd),
...
pub fn pwritev2(fd: fd_t, iov: [*]const iovec_const, count: usize, offset: i64, flags: kernel_rwf) usize {
    const offset_u: u64 = @bitCast(offset);
    return syscall6(
        .pwritev2,
        usizeFromFd(fd),
...
pub fn rmdir(path: [*:0]const u8) usize {
    if (@hasField(SYS, "rmdir")) {
        ...
        return syscall3(.unlinkat, usizeFromFd(AT.FDCWD), @intFromPtr(path), AT.REMOVEDIR);
    }
}
...
pub fn symlink(existing: [*:0]const u8, new: [*:0]const u8) usize {
    if (@hasField(SYS, "symlink")) {
        ...
        return syscall3(.symlinkat, @intFromPtr(existing), usizeFromFd(AT.FDCWD), @intFromPtr(new));
    }
}

pub fn symlinkat(existing: [*:0]const u8, newfd: fd_t, newpath: [*:0]const u8) usize {
    return syscall3(.symlinkat, @intFromPtr(existing), usizeFromFd(newfd), @intFromPtr(newpath));
}

pub fn pread(fd: fd_t, buf: [*]u8, count: usize, offset: i64) usize {
...
pub fn faccessat(dirfd: fd_t, path: [*:0]const u8, mode: u32, flags: u32) usize {
    if (flags == 0) {
        return syscall3(.faccessat, usizeFromFd(dirfd), @intFromPtr(path), mode);
    }
    return syscall4(.faccessat2, usizeFromFd(dirfd), @intFromPtr(path), mode, flags);
}
...
pub fn write(fd: fd_t, buf: [*]const u8, count: usize) usize {
    return syscall3(.write, usizeFromFd(fd), @intFromPtr(buf), count);
}

pub fn ftruncate(fd: fd_t, length: i64) usize {
...
pub fn pwrite(fd: fd_t, buf: [*]const u8, count: usize, offset: i64) usize {
...
pub fn openat(dirfd: fd_t, path: [*:0]const u8, flags: O, mode: mode_t) usize {
    ...
    return syscall4(.openat, usizeFromFd(dirfd), @intFromPtr(path), @as(u32, @bitCast(flags)), mode);
}
...
pub fn close(fd: fd_t) usize {
    return syscall1(.close, usizeFromFd(fd));
}
...
pub fn close_range(first: fd_t, last: fd_t, flags: CLOSE_RANGE) usize {
    return syscall3(.close_range, usizeFromFd(first), usizeFromFd(last), @as(u32, @bitCast(flags)));
}

pub fn fchmod(fd: fd_t, mode: mode_t) usize {
    return syscall2(.fchmod, usizeFromFd(fd), mode);
}
...
pub fn fchown(fd: fd_t, owner: uid_t, group: gid_t) usize {
    if (@hasField(SYS, "fchown32")) {
        return syscall3(.fchown32, usizeFromFd(fd), owner, group);
    } else {
        return syscall3(.fchown, usizeFromFd(fd), owner, group);
    }
}

pub fn fchownat(fd: fd_t, path: [*:0]const u8, owner: uid_t, group: gid_t, flags: u32) usize {
    return syscall5(.fchownat, usizeFromFd(fd), @intFromPtr(path), owner, group, flags);
}
...
pub fn fchmodat(fd: fd_t, path: [*:0]const u8, mode: mode_t) usize {
    return syscall3(.fchmodat, usizeFromFd(fd), @intFromPtr(path), mode);
}

pub fn fchmodat2(fd: fd_t, path: [*:0]const u8, mode: mode_t, flags: u32) usize {
    return syscall4(.fchmodat2, usizeFromFd(fd), @intFromPtr(path), mode, flags);
}

/// Can only be called on 32 bit systems. For 64 bit see `lseek`.
pub fn llseek(fd: fd_t, offset: u64, result: ?*u64, whence: usize) usize {
...
pub fn lseek(fd: fd_t, offset: i64, whence: usize) usize {
    return syscall3(.lseek, usizeFromFd(fd), @as(usize, @bitCast(offset)), whence);
}

pub fn exit(status: i32) noreturn {
    _ = syscall1(.exit, usizeFromI32(status));
    unreachable;
}

pub fn exit_group(status: i32) noreturn {
    _ = syscall1(.exit_group, usizeFromI32(status));
    unreachable;
}
...
pub fn kill(pid: pid_t, sig: SIG) usize {
    return syscall2(.kill, usizeFromPid(pid), @intFromEnum(sig));
}

pub fn tkill(tid: pid_t, sig: SIG) usize {
    return syscall2(.tkill, usizeFromPid(tid), @intFromEnum(sig));
}

pub fn tgkill(tgid: pid_t, tid: pid_t, sig: SIG) usize {
    return syscall3(.tgkill, usizeFromPid(tgid), usizeFromPid(tid), @intFromEnum(sig));
}
...
pub fn unlink(path: [*:0]const u8) usize {
    if (@hasField(SYS, "unlink")) {
        ...
        return syscall3(.unlinkat, usizeFromFd(AT.FDCWD), @intFromPtr(path), 0);
    }
}

pub fn unlinkat(dirfd: fd_t, path: [*:0]const u8, flags: u32) usize {
    return syscall3(.unlinkat, usizeFromFd(dirfd), @intFromPtr(path), flags);
}

pub fn waitpid(pid: pid_t, status: *u32, flags: u32) usize {
    return syscall4(.wait4, usizeFromPid(pid), @intFromPtr(status), flags, 0);
}
...
pub const F = struct {
    ...
    pub const SETLEASE = 1024 + 0;
    pub const GETLEASE = 1024 + 1;

    /// Request notifications on a directory.
    pub const NOTIFY = 1024 + 2;

    /// Cancel a blocking posix lock.
    pub const CANCELLK = 1024 + 5;

    /// Create a file descriptor with FD_CLOEXEC set.
    pub const DUPFD_CLOEXEC = 1024 + 6;

    /// Set pipe page size array
    pub const SETPIPE_SZ = 1024 + 7;
    /// Get pipe page size array
    pub const GETPIPE_SZ = 1024 + 8;

    /// Add seals to a file.
    pub const ADD_SEALS = 1024 + 9;
    /// Get seals on a file.
    pub const GET_SEALS = 1024 + 10;
    ...
    pub const GET_RW_HINT = 1024 + 11;
    pub const SET_RW_HINT = 1024 + 12;
    pub const GET_FILE_RW_HINT = 1024 + 13;
    pub const SET_FILE_RW_HINT = 1024 + 14;
};
...
pub fn fcntl(fd: fd_t, cmd: i32, arg: usize) usize {
    if (@hasField(SYS, "fcntl64")) {
        return syscall3(.fcntl64, usizeFromFd(fd), usizeFromI32(cmd), arg);
    } else {
        return syscall3(.fcntl, usizeFromFd(fd), usizeFromI32(cmd), arg);
    }
}

pub fn flock(fd: fd_t, operation: i32) usize {
    return syscall2(.flock, usizeFromFd(fd), usizeFromI32(operation));
}
...
pub fn getsockname(fd: fd_t, noalias addr: *sockaddr, noalias len: *socklen_t) usize {
    if (native_arch == .x86) {
        return socketcall(SC.getsockname, &[3]usize{ usizeFromFd(fd), @intFromPtr(addr), @intFromPtr(len) });
    }
    return syscall3(.getsockname, usizeFromFd(fd), @intFromPtr(addr), @intFromPtr(len));
}

pub fn getpeername(fd: fd_t, noalias addr: *sockaddr, noalias len: *socklen_t) usize {
    if (native_arch == .x86) {
        return socketcall(SC.getpeername, &[3]usize{ usizeFromFd(fd), @intFromPtr(addr), @intFromPtr(len) });
    }
    return syscall3(.getpeername, usizeFromFd(fd), @intFromPtr(addr), @intFromPtr(len));
}
...
pub fn setsockopt(fd: fd_t, level: i32, optname: u32, optval: [*]const u8, optlen: socklen_t) usize {
    if (native_arch == .x86) {
        return socketcall(SC.setsockopt, &[5]usize{ usizeFromFd(fd), usizeFromI32(level), optname, @intFromPtr(optval), @as(usize, @intCast(optlen)) });
    }
    return syscall5(.setsockopt, usizeFromFd(fd), usizeFromI32(level), optname, @intFromPtr(optval), @as(usize, @intCast(optlen)));
}

pub fn getsockopt(fd: fd_t, level: i32, optname: u32, noalias optval: [*]u8, noalias optlen: *socklen_t) usize {
    if (native_arch == .x86) {
        return socketcall(SC.getsockopt, &[5]usize{ usizeFromFd(fd), usizeFromI32(level), optname, @intFromPtr(optval), @intFromPtr(optlen) });
    }
    return syscall5(.getsockopt, usizeFromFd(fd), usizeFromI32(level), optname, @intFromPtr(optval), @intFromPtr(optlen));
}

pub fn sendmsg(fd: fd_t, msg: *const msghdr_const, flags: u32) usize {
    const fd_usize = usizeFromFd(fd);
...
pub fn sendmmsg(fd: fd_t, msgvec: [*]mmsghdr, vlen: u32, flags: u32) usize {
    return syscall4(.sendmmsg, usizeFromFd(fd), @intFromPtr(msgvec), vlen, flags);
}
...
pub fn shutdown(fd: fd_t, how: i32) usize {
    if (native_arch == .x86) {
        return socketcall(SC.shutdown, &[2]usize{ usizeFromFd(fd), usizeFromI32(how) });
    }
    return syscall2(.shutdown, usizeFromFd(fd), usizeFromI32(how));
}

pub fn bind(fd: fd_t, addr: *const sockaddr, len: socklen_t) usize {
    if (native_arch == .x86) {
        return socketcall(SC.bind, &[3]usize{ usizeFromFd(fd), @intFromPtr(addr), @as(usize, @intCast(len)) });
    }
    return syscall3(.bind, usizeFromFd(fd), @intFromPtr(addr), @as(usize, @intCast(len)));
}

pub fn listen(fd: fd_t, backlog: u32) usize {
    if (native_arch == .x86) {
        return socketcall(SC.listen, &[2]usize{ usizeFromFd(fd), backlog });
    }
    return syscall2(.listen, usizeFromFd(fd), backlog);
}

pub fn sendto(fd: fd_t, buf: [*]const u8, len: usize, flags: u32, addr: ?*const sockaddr, alen: socklen_t) usize {
    if (native_arch == .x86) {
        return socketcall(SC.sendto, &[6]usize{ usizeFromFd(fd), @intFromPtr(buf), len, flags, @intFromPtr(addr), @as(usize, @intCast(alen)) });
    }
    return syscall6(.sendto, usizeFromFd(fd), @intFromPtr(buf), len, flags, @intFromPtr(addr), @as(usize, @intCast(alen)));
}

pub fn sendfile(outfd: fd_t, infd: fd_t, offset: ?*i64, count: usize) usize {
...
pub fn accept(fd: fd_t, noalias addr: ?*sockaddr, noalias len: ?*socklen_t) usize {
    if (native_arch == .x86) {
        return socketcall(SC.accept, &[4]usize{ usizeFromFd(fd), @intFromPtr(addr), @intFromPtr(len), 0 });
    }
...
pub fn accept4(fd: fd_t, noalias addr: ?*sockaddr, noalias len: ?*socklen_t, flags: u32) usize {
    if (native_arch == .x86) {
        return socketcall(SC.accept4, &[4]usize{ usizeFromFd(fd), @intFromPtr(addr), @intFromPtr(len), flags });
    }
    return syscall4(.accept4, usizeFromFd(fd), @intFromPtr(addr), @intFromPtr(len), flags);
}
...
pub fn flistxattr(fd: fd_t, list: [*]u8, size: usize) usize {
    return syscall3(.flistxattr, usizeFromFd(fd), @intFromPtr(list), size);
}
...
pub fn fgetxattr(fd: fd_t, name: [*:0]const u8, value: [*]u8, size: usize) usize {
    return syscall4(.fgetxattr, usizeFromFd(fd), @intFromPtr(name), @intFromPtr(value), size);
}
...
pub fn fsetxattr(fd: fd_t, name: [*:0]const u8, value: [*]const u8, size: usize, flags: usize) usize {
    return syscall5(.fsetxattr, usizeFromFd(fd), @intFromPtr(name), @intFromPtr(value), size, flags);
}
...
pub fn sched_setparam(pid: pid_t, param: *const sched_param) usize {
    return syscall2(.sched_setparam, usizeFromPid(pid), @intFromPtr(param));
}

pub fn sched_getparam(pid: pid_t, param: *sched_param) usize {
    return syscall2(.sched_getparam, usizeFromPid(pid), @intFromPtr(param));
}

pub fn sched_setscheduler(pid: pid_t, policy: SCHED, param: *const sched_param) usize {
    return syscall3(.sched_setscheduler, usizeFromPid(pid), @intCast(@as(u32, @bitCast(policy))), @intFromPtr(param));
}

pub fn sched_getscheduler(pid: pid_t) usize {
    return syscall1(.sched_getscheduler, usizeFromPid(pid));
}
...
pub fn sched_setattr(pid: pid_t, attr: *const sched_attr, flags: usize) usize {
    return syscall3(.sched_setattr, usizeFromPid(pid), @intFromPtr(attr), flags);
}

pub fn sched_getattr(pid: pid_t, attr: *sched_attr, size: usize, flags: usize) usize {
    return syscall4(.sched_getattr, usizeFromPid(pid), @intFromPtr(attr), size, flags);
}

pub fn sched_rr_get_interval(pid: pid_t, tp: *timespec) usize {
    return syscall2(.sched_rr_get_interval, usizeFromPid(pid), @intFromPtr(tp));
}
...
pub fn sched_getaffinity(pid: pid_t, size: usize, set: *cpu_set_t) usize {
    const rc = syscall3(.sched_getaffinity, usizeFromPid(pid), size, @intFromPtr(set));
    if (@as(isize, @bitCast(rc)) < 0) return rc;
...
pub fn sched_setaffinity(pid: pid_t, set: *const cpu_set_t) !void {
    ...
    const rc = syscall3(.sched_setaffinity, usizeFromPid(pid), size, @intFromPtr(set));
...
pub fn epoll_ctl(epoll_fd: fd_t, op: u32, fd: fd_t, ev: ?*epoll_event) usize {
    return syscall4(.epoll_ctl, usizeFromFd(epoll_fd), @as(usize, @intCast(op)), usizeFromFd(fd), @intFromPtr(ev));
}
...
pub fn epoll_pwait(epoll_fd: fd_t, events: [*]epoll_event, maxevents: u32, timeout: i32, sigmask: ?*const sigset_t) usize {
    return syscall6(
        .epoll_pwait,
        usizeFromFd(epoll_fd),
        @intFromPtr(events),
        @as(usize, @intCast(maxevents)),
        usizeFromI32(timeout),
        @intFromPtr(sigmask),
        NSIG / 8,
    );
}
...
pub fn setns(fd: fd_t, flags: u32) usize {
    return syscall2(.setns, usizeFromFd(fd), flags);
}
...
pub fn io_uring_enter(fd: fd_t, to_submit: u32, min_complete: u32, flags: u32, sig: ?*sigset_t) usize {
    return syscall6(.io_uring_enter, usizeFromFd(fd), to_submit, min_complete, flags, @intFromPtr(sig), NSIG / 8);
}

pub fn io_uring_register(fd: fd_t, opcode: IORING_REGISTER, arg: ?*const anyopaque, nr_args: u32) usize {
    return syscall4(.io_uring_register, usizeFromFd(fd), @intFromEnum(opcode), @intFromPtr(arg), nr_args);
}
...
pub fn getrusage(who: i32, usage: *rusage) usize {
    return syscall2(.getrusage, usizeFromI32(who), @intFromPtr(usage));
}

pub fn tcgetattr(fd: fd_t, termios_p: *termios) usize {
    return syscall3(.ioctl, usizeFromFd(fd), T.CGETS, @intFromPtr(termios_p));
}

pub fn tcsetattr(fd: fd_t, optional_action: TCSA, termios_p: *const termios) usize {
    return syscall3(.ioctl, usizeFromFd(fd), T.CSETS + @intFromEnum(optional_action), @intFromPtr(termios_p));
}

pub fn tcgetpgrp(fd: fd_t, pgrp: *pid_t) usize {
    return syscall3(.ioctl, usizeFromFd(fd), T.IOCGPGRP, @intFromPtr(pgrp));
}

pub fn tcsetpgrp(fd: fd_t, pgrp: *const pid_t) usize {
    return syscall3(.ioctl, usizeFromFd(fd), T.IOCSPGRP, @intFromPtr(pgrp));
}

pub fn tcdrain(fd: fd_t) usize {
    return syscall3(.ioctl, usizeFromFd(fd), T.CSBRK, 1);
}

pub fn ioctl(fd: fd_t, request: u32, arg: usize) usize {
    return syscall3(.ioctl, usizeFromFd(fd), request, arg);
}

pub fn signalfd(fd: fd_t, mask: *const sigset_t, flags: u32) usize {
    return syscall4(.signalfd4, usizeFromFd(fd), @intFromPtr(mask), NSIG / 8, flags);
}
...
pub fn syncfs(fd: fd_t) usize {
    return syscall1(.syncfs, usizeFromFd(fd));
}

pub fn fsync(fd: fd_t) usize {
    return syscall1(.fsync, usizeFromFd(fd));
}

pub fn fdatasync(fd: fd_t) usize {
    return syscall1(.fdatasync, usizeFromFd(fd));
}

pub fn prctl(op: i32, arg2: usize, arg3: usize, arg4: usize, arg5: usize) usize {
    return syscall5(.prctl, usizeFromI32(op), arg2, arg3, arg4, arg5);
}
...
pub fn pidfd_open(pid: pid_t, flags: u32) usize {
    return syscall2(.pidfd_open, usizeFromPid(pid), flags);
}
...
inline fn usizeFromFd(fd: fd_t) usize {
    return usizeFromSigned(fd);
}

inline fn usizeFromPid(pid: pid_t) usize {
    return usizeFromSigned(pid);
}

inline fn usizeFromI32(value: i32) usize {
    return usizeFromSigned(value);
}

inline fn usizeFromSigned(value: anytype) usize {
    comptime {
        const t = @TypeOf(value);
        switch (@typeInfo(t)) {
            .int => |it| std.debug.assert(it.signedness == .signed and it.bits <= @bitSizeOf(usize)),
            .comptime_int => {},
            else => @compileError("Expected signed integer, found '" ++ @typeName(t) ++ "'"),
        }
    }
