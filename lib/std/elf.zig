...
pub const EM = enum(u16) {
    ...
    pub fn description(em: EM) []const u8 {
        return switch (em) {
            .NONE => "None",
            .M32 => "AT&T WE 32100",
            .SPARC => "Sun SPARC",
            ...
            .MIPS => "MIPS R3000",
            .S370 => "IBM System/370",
            .MIPS_RS3_LE => "MIPS R3000 little-endian",
            .OLD_SPARCV9 => "Sun Sparc v9 (pre-ABI)",
            .PARISC => "HPPA",
            .VPP500 => "Fujitsu VPP500",
            .SPARC32PLUS => "Sun SPARC V8Plus",
            .@"960" => "Intel 80960",
            .PPC => "PowerPC",
            .PPC64 => "PowerPC64",
            .S390 => "IBM S/390",
            ...
            .ARC => "ARC Cores",
            .H8_300 => "Renesas H8/300",
            .H8_300H => "Renesas H8/300H",
            .H8S => "Renesas H8S",
            .H8_500 => "Renesas H8/500",
            .IA_64 => "Intel IA-64",
            ...
            .NCPU => "Sony nCPU",
            .NDR1 => "Denso NDR1",
            .STARCORE => "Motorola Star*Core",
            .ME16 => "Toyota ME16",
            .ST100 => "STMicroelectronics ST100",
            .TINYJ => "Advanced Logic TinyJ",
            .X86_64 => "Advanced Micro Devices X86-64",
            .PDSP => "Sony DSP",
            .PDP10 => "DEC PDP-10",
            .PDP11 => "DEC PDP-11",
            .FX66 => "Siemens FX66",
            .ST9PLUS => "STMicroelectronics ST9+ 8/16-bit",
            .ST7 => "STMicroelectronics ST7 8-bit",
            .@"68HC16" => "Motorola MC68HC16",
            .@"68HC11" => "Motorola MC68HC11",
            .@"68HC08" => "Motorola MC68HC08",
            .@"68HC05" => "Motorola MC68HC05",
            .SVX => "Silicon Graphics SVx",
            .ST19 => "STMicroelectronics ST19 8-bit",
            .VAX => "Digital VAX",
            .CRIS => "Axis CRIS",
            .JAVELIN => "Infineon Javelin",
            .FIREPATH => "Element 14 64-bit DSP",
            .ZSP => "LSI Logic ZSP",
            .MMIX => "MMIX",
            .HUANY => "Harvard HUANY",
            .PRISM => "SiTera Prism",
            ...
            .PJ => "picoJava",
            .OR1K => "OpenRISC 1000",
            .ARC_COMPACT => "ARC ARCompact",
            .XTENSA => "Tensilica Xtensa",
            .VIDEOCORE => "Alphamosaic VideoCore",
            .TMM_GPP => "Thomson Multimedia TMM_GPP",
            .NS32K => "National Semiconductor NS32K",
            .TPC => "Tenor Network TPC",
            ...
            .SE_C33 => "Seiko Epson S1C33",
            .SEP => "Sharp SEP",
            .ARCA => "Arca RISC",
            .UNICORE => "PKU-Unity UniCore",
            .EXCESS => "eXcess configurable embedded CPU",
            .DXP => "Icera Deep Execution Processor",
            .ALTERA_NIOS2 => "Altera Nios II",
            .CRX => "National Semiconductor CRX",
            .XGATE => "Motorola XGATE",
            .C166 => "Infineon C16x/XC16x",
            .M16C => "Renesas M16C",
            .DSPIC30F => "Microchip dsPIC30F",
            .CE => "Freescale Communication Engine",
            .M32C => "Renesas M32C",
            .TSK3000 => "Altium TSK3000",
            .RS08 => "Freescale RS08",
            .SHARC => "Analog Devices SHARC 32-bit DSP",
            .ECOG2 => "Cyan Technology eCOG2",
            .SCORE => "Sunplus S+core",
            .DSP24 => "NJR DSP24 24-bit",
            .VIDEOCORE3 => "Broadcom VideoCore III",
            .LATTICEMICO32 => "Lattice LatticeMico32",
            .SE_C17 => "Seiko Epson C17",
            .TI_C6000 => "TI TMS320C6000 DSP",
            .TI_C2000 => "TI TMS320C2000 DSP",
            .TI_C5500 => "TI TMS320C55x DSP",
            .TI_ARP32 => "TI ARP32 application-specific RISC",
            .TI_PRU => "TI PRU",
            .MMDSP_PLUS => "STMicroelectronics MMDSP+ 64-bit VLIW DSP",
            .CYPRESS_M8C => "Cypress M8C",
            .R32C => "Renesas R32C",
            .TRIMEDIA => "NXP TriMedia",
            .QDSP6 => "Qualcomm Hexagon",
            .@"8051" => "Intel 8051",
            .STXP7X => "STMicroelectronics STxP7x",
            .NDS32 => "Andes NDS32",
            .ECOG1X => "Cyan Technology eCOG1X",
            .MAXQ30 => "Dallas Semiconductor MAXQ30",
            .XIMO16 => "NJR XIMO16 16-bit",
            .MANIK => "M2000 Manik",
            .CRAYNV2 => "Cray NV2",
            .RX => "Renesas RX",
            .METAG => "Imagination Meta",
            .MCST_ELBRUS => "MCST Elbrus",
            .ECOG16 => "Cyan Technology eCOG16",
            .CR16 => "National Semiconductor CompactRISC 16-bit",
            .ETPU => "Freescale eTPU",
            .SLE9X => "Infineon SLE9X",
            .L10M => "Intel L10M",
            .K10M => "Intel K10M",
            .AARCH64 => "AArch64",
            .AVR32 => "Atmel AVR32",
            .STM8 => "STMicroelectronics STM8 8-bit",
            .TILE64 => "Tilera TILE64",
            .TILEPRO => "Tilera TILEPro",
            .MICROBLAZE => "Xilinx MicroBlaze 32-bit",
            .CUDA => "NVIDIA CUDA",
            .TILEGX => "Tilera TILE-Gx",
            .CLOUDSHIELD => "CloudShield",
            .COREA_1ST => "KIPO-KAIST Core-A (1st gen)",
            .COREA_2ND => "KIPO-KAIST Core-A (2nd gen)",
            .ARC_COMPACT2 => "Synopsys ARCompact V2",
            .OPEN8 => "Open8 8-bit RISC",
            .RL78 => "Renesas RL78",
            .VIDEOCORE5 => "Broadcom VideoCore V",
            .@"78K0R" => "Renesas 78K0R",
            .@"56800EX" => "Freescale 56800EX Digital Signal Controller (DSC)",
            .BA1 => "Beyond BA1",
            .BA2 => "Beyond BA2",
            .XCORE => "XMOS xCORE",
            .MCHP_PIC => "Microchip 8-bit PIC",
            .INTELGT => "Intel Graphics Technology",
            .KM32 => "KM211 KM32 32-bit",
            .KMX32 => "KM211 KMX32 32-bit",
            .KMX16 => "KM211 KMX16 16-bit",
            .KMX8 => "KM211 KMX8 8-bit",
            .KVARC => "KM211 KVARC",
            .CDP => "Paneve CDP",
            .COGE => "Cognitive Smart Memory",
            .COOL => "Bluechip Systems CoolEngine",
            .NORC => "Nanoradio Optimized RISC",
            .CSR_KALIMBA => "CSR Kalimba",
            .Z80 => "Zilog Z80",
            .VISIUM => "CDS VISIUMcore",
            .FT32 => "FTDI FT32",
            .MOXIE => "Moxie",
            .AMDGPU => "AMD GPU",
            .RISCV => "RISC-V",
            ...
            .MCS6502 => "MOS Technology MCS 6502",
            ...
            .AIENGINE => "AMD/Xilinx AIEngine",
            .SIMA_MLA => "SiMa MLA",
            .BANG => "Cambricon BANG",
            .LOONGGPU => "Loongson LoongGPU",
            .SW64 => "Sunway SW64",
            .AVR_OLD => "AVR",
            .MSP430_OLD => "MSP430",
            .MT => "Morpho MT",
            ...
            .CYGNUS_POWERPC => "Cygnus PowerPC",
            .ALPHA => "Alpha",
            .CYGNUS_M32R => "Cygnus M32R",
            .CYGNUS_V850 => "V850",
            .S390_OLD => "IBM S/390 (old)",
            .XTENSA_OLD => "Xtensa (old unofficial)",
            .XSTORMY16 => "Xstormy16",
            .CYGNUS_MN10300 => "MN10300",
            .CYGNUS_MN10200 => "MN10200",
            .M32C_OLD => "Renesas M32C (old)",
            .IQ2000 => "Vitesse IQ2000",
            .NIOS32 => "NIOS",
            .CYGNUS_MEP => "Toshiba MeP",
            .MOXIE_OLD => "Moxie (old unofficial)",
            .MICROBLAZE_OLD => "MicroBlaze (old)",
            .ADAPTEVA_EPIPHANY => "Adapteva Epiphany",
            .PROPELLER => "Parallax Propeller (P1)",
            .PROPELLER2 => "Parallax Propeller 2 (P2)",
            else => @tagName(em),
        };
    }
};
