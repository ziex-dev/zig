...
pub const P256 = struct {
    ...
    pub fn fromSerializedAffineCoordinates(xs: [32]u8, ys: [32]u8, endian: std.lang.Endian) (NonCanonicalError || EncodingError)!P256 {
    ...
    pub fn mul(p: P256, s_: [32]u8, endian: std.lang.Endian) IdentityElementError!P256 {
    ...
    pub fn mulPublic(p: P256, s_: [32]u8, endian: std.lang.Endian) IdentityElementError!P256 {
        const s = if (endian == .little) s_ else Fe.orderSwap(s_);
        if (p.is_base) {
    ...
    /// This can be used for signature verification.
    pub fn mulDoubleBasePublic(p1: P256, s1_: [32]u8, p2: P256, s2_: [32]u8, endian: std.lang.Endian) IdentityElementError!P256 {
