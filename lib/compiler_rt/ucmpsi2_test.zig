...
test "ucmpsi2" {
    ...
    // intMin/2 == 0
    // intMax/2 == 2147483647
    // 1. equality   0, 1 intMax/2, intMax-1, intMax
    ...
    // 9. cmp intMax-1, {0,1,2, intMax/2, intMax}
    ...
    // 10.cmp intMax,   {0,1,2, intMax/2, intMax-1}
