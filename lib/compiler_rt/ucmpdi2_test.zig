...
test "ucmpdi2" {
    ...
    // intMin/2 == 0
    // intMax/2 == 9223372036854775807
    // 1. equality intMin, intMin/2, 0, intMax/2, intMax
    ...
    // 2. cmp intMin,   {intMin + 1, intMax/2, intMax-1, intMax}
    ...
    // 3. cmp intMin+1, {intMin, intMax/2, intMax-1, intMax}
    ...
    // 6. cmp 0,        {}
    // 7. cmp 1,        {}
    // 8. cmp intMax/2, {intMin, intMin+1, intMax-1, intMax}
    ...
    // 9. cmp intMax-1, {intMin, intMin + 1, intMax/2, intMax}
    ...
    // 10.cmp intMax,   {intMin, 1, intMax/2, intMax-1}
