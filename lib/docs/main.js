(function() {
    ...
    function renderDeclHeading(decl_index) {
      ...
      const hdrNameSpan = domHdrName.children[0].children[0];
      const hdrCategSpan = domHdrName.children[0].children[2];
      const srcLink = domHdrName.children[1];
      hdrNameSpan.innerText = unwrapString(wasm_exports.decl_name(decl_index));
      hdrCategSpan.innerText = unwrapString(wasm_exports.decl_category_name(decl_index));
