...
fn initResource(f: *Fetch, uri: std.Uri, resource: *Resource, reader_buffer: []u8) RunError!void {
    ...
    {
        f.retry.callWithRetries(io, @TypeOf(initHttpResource), initHttpResource, .{ f, uri, resource, reader_buffer }) catch |err| {
    ...
    {
        f.retry.callWithRetries(io, @TypeOf(initGitResource), initGitResource, .{ f, uri, resource, reader_buffer }) catch |err| {
